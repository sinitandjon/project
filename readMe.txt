The project is a search engine designed to extract and index relevant content from the public websites **public.fr** and **vsd.fr**,
leveraging cutting-edge machine learning techniques. First, a web scraping process gathers articles and textual data from these websites.
The scraped content is then processed using the pre-trained **SentenceTransformer('all-MiniLM-L6-v2')** model, 
